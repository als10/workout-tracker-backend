...
import (
	...
	"github.com/als10/workout-tracker-backend/utils"
)
...
func DeserializeUser() gin.HandlerFunc {
	return func(ctx *gin.Context) {
		...
		if result.Error != nil {
			ctx.AbortWithStatusJSON(http.StatusForbidden, gin.H{"status": "fail", "message": "User belonging to this token no logger exists!"})
			return
		}
